	...
	function update_design_table2(fpn_threshold, fnpt_threshold) {
		...
		function(d,i) {
			...
			return {
				...
				fpn:		[ +d.fpn1,+d.fpn2, +d.fpn3, +d.fpn4, +d.fpn5, +d.fpn6, +d.fpn7, +d.fpn8, +d.fpn9, +d.fpn10,
							 ...
							 +d.fpn61,+d.fpn62,+d.fpn63,+d.fpn64,+d.fpn65,+d.fpn66,+d.fpn67,+d.fpn68,+d.fpn69,+d.fpn70,
							 +d.fpn71,+d.fpn72,+d.fpn73,+d.fpn74,+d.fpn75,+d.fpn76,+d.fpn77,+d.fpn78,+d.fpn79,+d.fpn80,
							 +d.fpn81,+d.fpn82,+d.fpn83,+d.fpn84,+d.fpn85,+d.fpn86,+d.fpn87,+d.fpn88,+d.fpn89,+d.fpn90,
		...
		function(error, data) {
			...
			for (var ii = 0; ii < filtered_designs.length; ii++) {
				...
				cell14.innerHTML = data[filtered_designs[ii]-1].PipeLay;
				cell15.innerHTML = data[filtered_designs[ii]-1].DFC;
				cell16.innerHTML = data[filtered_designs[ii]-1].deck_area;
				cell17.innerHTML = data[filtered_designs[ii]-1].dwt;
				cell18.innerHTML = data[filtered_designs[ii]-1].speed;
